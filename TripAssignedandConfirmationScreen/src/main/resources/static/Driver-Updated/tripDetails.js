...
function getdetail() {
	...
	xhr.open("GET", "http://localhost:8080/Getalldetails/" + id, true);
...
alert("hi");
	...
	xhr.open("GET", "http://localhost:8080/Getalldetails/" + id,false);
...
function starttripforshow() {
	...
	var url = "http://localhost:8080/update/for/show/" + id;
...
function ongoingForTripCabInfo() {
	...
	xhrupdate.open("PUT",  "http://localhost:8080/updateme/Ongoing/" + id, true);
